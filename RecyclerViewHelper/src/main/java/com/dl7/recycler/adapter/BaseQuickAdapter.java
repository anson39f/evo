...
public abstract class BaseQuickAdapter<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder>
    ...
    protected int mDragFixCount = 0;  // 固定数量，从0开始算
...
//                ViewGroup.LayoutParams.MATCH_PARENT));
     ...
     * @return
     */
    public int _calcPosition(int position) {
        if (mHeaderView != null) {
            position++;
        }
        return position;
...
//            Log.e("",mData.toString());
     ...
     * @param position
     */
    protected void _setDragFixBackground(RecyclerView.ViewHolder holder, int position) {
