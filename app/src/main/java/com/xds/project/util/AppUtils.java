...
import com.xds.project.data.bean.Course;
import com.xds.project.data.bean.CsItem;
...
import com.xds.project.db.CourseDbDao;
import com.xds.project.widget.UpdateJobService;
...
public class AppUtils {
    ...
    public static int getCurrentWeek(Context context) {
        ...
        //获取开始时间
        String beginMillis = PreferencesUtils.getString(context, context.getString(
    ...
    public static void PreferencesCurrentWeek(Context context, int currentWeekCount) {
        ...
        PreferencesUtils.putString(context, context.getString(R.string.app_preference_start_week_begin_millis),
    ...
    public static void updateWidget(Context context) {
        ...
        intent.setAction("com.xds.project.action.UPDATE_WIDGET");
        intent.setComponent(new ComponentName("com.xds.project.gzuclassschedule", "com.xds.project.gzuclassschedule.widget.MyWidget"));
